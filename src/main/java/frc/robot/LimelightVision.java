 ...
 * 
 * <p>The Limelight coordinate systems are at
 ...
 * <p>Example usage NOT using {@link VisionContainer}:
 <pre><code>
...
public class LimelightVision  extends CameraBase {
    ...
    /**
     * Camera-Space Transform3d of how a tag has moved away from the camera that is facing the camera
    ...
    */
    ...
    public void update() {
        ...
        LimelightHelpers.SetRobotOrientation(limelightName, drivetrain.getHeading(), drivetrain.getRate(), 0., 0.,0., 0.);
...
// if it's somewhat far from the odometry.
  ...
  public static boolean isAvailable(String limelightName)
  {
    ...
    {
        errMsg = errMsg + "Enter the IP address below on the interface to the Limelight for Dashboard: Settings / Custom NT Server IP:\n";
        errMsg = errMsg + RobotContainer.whatsMyIPAddress();
    }
  ...
  /**
   * Utility toString method for printing a double array
   * @param array
